...
<html>
  ...
  <body>
    ...
    ?>
      ...
      Busqueda avanzada <input type="text" data-tabla="equipo" id="buscar" value=""></br>
      ...
      <div id="dialogomodificar" title="Modificar Equipos">
          <form  id="formulario" action="equipos.php" method="POST">
            <div class="form-group">
              <b><label for="codigoId">Codigo Equipo</label><br>
                <input type="number" class="form-control" name="codequi" id="codigoId" min="1" step="1" autocomplete required readonly="readonly"></b>
            </div>
            <div class="form-group">
              <b><label for="nombreId">Equipo</label><br>
                <input type="text" class="form-control" name="nomequi" id="nombreId" required></b>
            </div>
          </form>
      </div>
      <script>
        $("#formulario").validate({
            ...
            messages: {
              codequi: {
                required: "Codigo de equipo requerido"
              },
              nomequi: {
      ...
      <!--boton añadir-->
      <button id="anadir" class="btn btn-info botonAnadir" data-tabla="equipo" data-campo="codequi"><span class="glyphicon glyphicon-plus"></span></button>
